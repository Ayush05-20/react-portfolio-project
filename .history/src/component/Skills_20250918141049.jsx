...
const skills = [
  ...
  { name: "JavaScript", level: 50, category: "frontend", icon: DiJsBadge },
  { name: "React", level: 70, category: "frontend", icon: Atom },
  { name: "Tailwind CSS", level: 50, category: "frontend", icon: SiTailwindcss },

  // AI & Machine Learning
  { name: "Python", level: 90, category: "ai & ml", icon: DiPython},
