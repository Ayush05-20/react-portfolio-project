      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center mb-20">
          <h2 className="text-5xl md:text-7xl font-black mb-6 relative">
            <span className="bg-gradient-to-r from-sky-400 via-blue-500 bg-clip-text text-transparent">
              About
            </span>
            <span className="mx-4 text-foreground/20">•</span>
            <span className="bg-gradient-to-r from-blue-500 via-pink-500 to-sky-400 bg-clip-text text-transparent">
              Me
            </span>
