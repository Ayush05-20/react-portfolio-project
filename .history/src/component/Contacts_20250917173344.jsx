                ...
                <div className='space-y-8'>
                    ...
                    <div className='pt-8'>
                        ...
                        <div className='flex space-x-4 justify-center'>
                            <a href="https://www.linkedin.com/in/ayush-shrestha-np/ target='_blank'">
                                <SiLinkedin className='h-6 w-6 text-muted-foreground hover:text-sky-400 transition-colors'/>
                            </a>
                            <a href="https://www.instagram.com/ayush.stha.355_/ target='_blank">
