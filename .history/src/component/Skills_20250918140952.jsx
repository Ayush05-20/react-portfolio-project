...
const Skills = () => {
    ...
    return (
        <section id='skills' className='py-32 px-4 relative min-h-screen overflow-hidden bg-seconday/30'>
            {/* Animated Background */}
            <div className="absolute inset-0">
                ...
                <div className="absolute inset-0 opacity-10">
                    <div className="absolute w-full h-full bg-gradient-to-r from-sky-400/20 to-blue-600/20 transform rotate-12 scale-150 animate-pulse"></div>
                    <div className="absolute w-full h-full bg-gradient-to-r from-purple-400/20 to-pink-600/20 transform -rotate-12 scale-150 animate-pulse" style={{animationDelay: '2s'}}></div>
                </div>
            </div>
